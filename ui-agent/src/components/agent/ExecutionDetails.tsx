                    ...
                    <div className="space-y-2">
                      {step.tool_calls.map((tool, i) => (
                        ...
                        >
                          ...
                          {tool.arguments && (
                            <pre className="mt-2 text-xs text-purple-600 overflow-x-auto scrollbar-default whitespace-pre-wrap break-all">
                ...
                {step.code_written && (
                  <div className="mt-3">
                    ...
                    <div className="bg-gray-900 rounded-md overflow-hidden">
                      <pre className="p-3 text-xs text-gray-100 overflow-x-auto scrollbar-default whitespace-pre-wrap break-all max-h-64">

...
export const TOOL_DISPLAY_CONFIG: ToolDisplayConfig = {
  ...
  tools: {
    ...
    knowledge_list: {
      ...
      detailKeys: ["kbId", "tags", "limit", "offset"],
    },
    knowledge_search: {
      emoji: "🔍",
      title: "Knowledge Search",
      detailKeys: ["query", "kbId", "limit"],
    },
    knowledge_delete: {
      emoji: "🗑️",
      title: "Knowledge Delete",
      detailKeys: ["kbId", "documentId"],
    },
    knowledge_get: {
      emoji: "📄",
      title: "Knowledge Get",
    ...
    set_avatar_state: {
      emoji: "🧍",
      title: "Set Avatar State",
      detailKeys: ["state", "emoteId", "expression"],
    },
    list_avatar_motions: {
      emoji: "🎭",
      title: "List Avatar Motions",
    },
  },
};
